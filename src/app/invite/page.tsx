        ...
        <div className="min-h-dvh flex item-center justify-between gap-16 flex-col md:flex-row">
            <div className="flex flex-col gap-10 w-full max-w-[550px]">
                ...
                <div className="space-y-2">
                    <h1 className="text-4xl font-semibold text-heading text-gray-100 leading-none">Inscrição confirmada!</h1>
                ...
                <div className="space-y-6">
                    <div className="space-y-3">
                        ...
                        <p className="tex-gray-300">Convide mais pessoas para o evento e concorra a prêmios exclusivos! É só compartilhar o link abaixo e acompanhar as inscrições:</p>
                    </div>
